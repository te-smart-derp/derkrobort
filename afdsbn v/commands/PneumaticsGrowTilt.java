...
public class PneumaticsGrowTilt extends CommandBase {
   ...
   */
  public PneumaticsGrowTilt(Pneumatics pneumatics, Drivetrain drivetrain, double growth) {
  ...
  @Override
  public void execute() {
    m_drivetrain.m_tilt(m_growth);
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    m_drivetrain.m_tilt(0);
  }
